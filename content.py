...
MODULES = [
 {"id":"m1","name":"Modul I · Laut & Schrift","topics":[
   {"id":"alphabet","t":"Alphabet & Aussprache","s":"ready","desc":"DE: ein Buchstabe – mehrere Laute; TR: weitgehend 1:1.","prio":{"h":"mittel","f":"gering","l":"hoch"}},
   {"id":"auslaut","t":"Auslautverhärtung","s":"ready","desc":"Finale Entstimmung – gleicher Laut, andere Schreibregel.","prio":{"h":"hoch","f":"mittel","l":"mittel"}},
   {"id":"sprossv","t":"Konsonantenhäufung & Sprossvokal","s":"ready","desc":"Vokaleinschub als L1-Phonotaktik.","prio":{"h":"hoch","f":"mittel","l":"gering"}},
   {"id":"graphem","t":"Graphem-Kontraste (v/w · z/s · c/ç · ı/i)","s":"ready","desc":"Gleiche Buchstaben, andere Lautwerte.","prio":{"h":"mittel","f":"gering","l":"mittel"}},
   {"id":"vokalh","t":"Vokalharmonie & Umlaut","s":"ready","desc":"TR-Vokalharmonie vs. DE-Umlaut als Morphemsignal.","prio":{"h":"mittel","f":"mittel","l":"mittel"}},
 ]},
 {"id":"m2","name":"Modul II · Morphologie","topics":[
   {"id":"genus","t":"Nomen: Genus & Artikel","s":"ready","desc":"der/die/das & Bestimmtheit – TR ohne Genus/Artikel.","prio":{"h":"hoch","f":"hoch","l":"hoch"}},
   {"id":"plural","t":"Nomen: Plural & Kasus","s":"ready","desc":"Pluraltypen vs. -lAr; 4 vs. 6 Kasus.","prio":{"h":"hoch","f":"hoch","l":"hoch"}},
   {"id":"pronomen","t":"Pronomen","s":"ready","desc":"Flexion vs. Possessivsuffix; Pro-Drop.","prio":{"h":"mittel","f":"mittel","l":"mittel"}},
   {"id":"kompar","t":"Komparation (Adjektive)","s":"ready","desc":"-er/am -sten vs. daha/en; „als“ über Ablativ.","prio":{"h":"mittel","f":"gering","l":"mittel"}},
   {"id":"verben","t":"Verben","s":"ready","desc":"Trennbarkeit & Verbklammer vs. Suffixkette.","prio":{"h":"hoch","f":"hoch","l":"hoch"}},
   {"id":"zeit","t":"Zeitformen","s":"ready","desc":"Tempussystem & Evidentialität.","prio":{"h":"hoch","f":"mittel","l":"hoch"}},
   {"id":"imperativ","t":"Imperativ","s":"ready","desc":"du/ihr/Sie vs. reichere TR-Höflichkeit.","prio":{"h":"gering","f":"gering","l":"gering"}},
   {"id":"konjunktiv","t":"Konjunktiv","s":"ready","desc":"K I/K II vs. Konditional -se/-sa.","prio":{"h":"mittel","f":"mittel","l":"mittel"}},
   {"id":"passiv","t":"Passiv","s":"ready","desc":"werden-Passiv vs. Suffix -Il-/-In-.","prio":{"h":"mittel","f":"mittel","l":"hoch"}},
   {"id":"praep","t":"Präpositionen vs. Kasussuffixe","s":"ready","desc":"DE-Präposition+Kasus ↔ TR-Suffix.","prio":{"h":"hoch","f":"hoch","l":"hoch"}},
   {"id":"adverb","t":"Adverbien","s":"ready","desc":"Adjektiv=Adverb; TeKaMoLo-Stellung.","prio":{"h":"mittel","f":"gering","l":"gering"}},
 ]},
 {"id":"m3","name":"Modul III · Syntax","topics":[
   {"id":"satzart","t":"Satzarten","s":"ready","desc":"Verbstellung vs. Fragepartikel mi.","prio":{"h":"mittel","f":"mittel","l":"mittel"}},
   {"id":"wortstell","t":"Wortstellung (SOV vs. V2)","s":"ready","desc":"TR verbfinal vs. DE Verbzweit/Klammer.","prio":{"h":"hoch","f":"hoch","l":"hoch"}},
   {"id":"relativ","t":"Relativsatz","s":"ready","desc":"DE-Relativpronomen vs. TR-Partizipialattribut.","prio":{"h":"mittel","f":"hoch","l":"mittel"}},
 ]},
]
...
LIT = {
 ...
 "Phonetik / Graphematik / Schriftspracherwerb": [
  ...
  dict(a="Şahiner, Pembe", y="2012", t="Phasen und Besonderheiten des Schriftspracherwerbs bei bilingual deutsch-türkischen Grundschulkindern",
       q="in: Grießhaber/Kalkavan (Hg.), Orthographie- und Schriftspracherwerb bei mehrsprachigen Kindern, 233–252. Freiburg i. Br.: Fillibach", proj=True),
 ...
 "DaZ/DaF-Didaktik & Zweitspracherwerb (Grundlagen)": [
  ...
  dict(a="Hoffmann, L. / Kameyama, S. / Riedel, M. / Şahiner, P. / Wulff, N. (Hg.)", y="2017",
       ...
       q="Berlin: Erich Schmidt Verlag (mit kontrastivem Überblick über Partnersprachen, u. a. Türkisch)", proj=True),
  dict(a="Jeuk, Stefan", y="2018", t="Deutsch als Zweitsprache in der Schule. Grundlagen – Diagnose – Förderung",
       q="4. Aufl. Stuttgart: W. Kohlhammer", proj=True),
  ...
  dict(a="Gebele, Diana", y="2018", t="Grammatik im Deutschunterricht mit neu zugewanderten Schülerinnen und Schülern",
       q="in: Gebele/Zepter (Hg.), Deutsch als Zweitsprache. Unterricht mit neu zugewanderten Kindern und Jugendlichen, 158–173. Baltmannsweiler: Schneider Hohengehren", proj=True),
  dict(a="Belke, Gerlind", y="2012", t="Mehr Sprache(n) für alle. Sprachunterricht in einer vielsprachigen Gesellschaft",
       q="5. Aufl. Baltmannsweiler: Schneider Verlag Hohengehren", proj=True),
...
LIT_INTRO = ("Auswahlbibliografie zum Sprachvergleich Deutsch–Türkisch und zur DaZ-Didaktik. "
  ...
  "aktuelle Arbeiten (2020+). Die letzte Rubrik versammelt didaktische und zweitspracherwerbliche "
...
GUIDE = dict(
 ...
 blocks=[
  ("Was diese Plattform ist",
   P("Eine didaktische Plattform zur <b>kontrastiven Linguistik Deutsch–Türkisch</b> für die "
     "DaZ-Lehramtsausbildung: Deutsch als Zweitsprache aus der Perspektive türkischer "
     "Erstsprache. Sie umfasst <b>19 Themen</b> in drei Modulen (Laut &amp; Schrift · Morphologie · "
  ...
  ("Wie jedes Thema aufgebaut ist",
   ...
   +"<ul class='li'>"
   "<li><b>1 · Kontrastiver Befund</b> – deutsche und türkische Struktur nebeneinander</li>"
   ...
   +P("<b>Lesekonventionen:</b> <span class='err'>Lernerform</span> (durchgestrichen) vs. "
     "<span class='ok'>Zielform</span>; "+k("türkische Tokens")+" kursiv in warmer Farbe, "
